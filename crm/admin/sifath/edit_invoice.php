                            ...
                            <tbody id="pd">
                              ...
                              ?>
                                <tr id="rem_<?php echo $i ?>">
                                  ...
                                  <td>
                                    <input type="text" class="form-control" id="t_<?php echo $i ?>" name="tot" readonly value="<?php echo $data['total'] ?>">
                                  </td>
                                  <td>
                                    <input type="text" class="form-control" name="vat[]" id="tx_<?php echo $i ?>" value="<?php echo $data['vat'] ?>" onkeyup="payable(<?php echo $i ?>)">
                                  </td>
                                  <td><input type="text" id="p_<?php echo $i ?>" name="stotal[]" class="total form-control" readonly value="<?php echo $data['payable'] ?>"></td>
        ...
        $.getJSON('fetch_data.php?id=' + id, function(data) {
          ...
          let ht = `<tr  id="rem_${i}">
                      ...
                      <td >
                        ...
                        <input type="hidden" class="form-control" id="pk_${i}" name="pid[]" readonly value="${data.id}" >
                      </td>

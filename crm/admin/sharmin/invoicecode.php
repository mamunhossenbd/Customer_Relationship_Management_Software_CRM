...
if (isset($_GET['id'])) {
    ...
    $d_info2 = $con->query('select * from dealer')->fetch_assoc();
...
<!-- background: linear-gradient(90deg, #9BD2A7 0%, #E0DFEF 100%); -->
<!-- style="background: linear-gradient(90deg, #EFB79F 0%, #ECD0DE 100%);"  -->
...
<div class="page-content container">
    <div class="page-header text-blue-d2">
        ...
        <div>
            ...
            <input name="dealer_id" type="text" value="<?php echo $dl_nam['name'] ?>">
        ...
        <br>
            ...
            <input name="customer_name" type="text" value="<?php echo  $d_info['name'] ?>">
                ...
                <div class="row container">
                    ...
                    <div class="text-95 col-sm-6 align-self-start d-sm-flex justify-content-start">
                        ...
                        <div class="text-grey-m2">
                            ...
                            <!-- 
                            <div class="my-2"><i class="fa fa-circle text-blue-m2 text-xs mr-1"></i> <span class="text-600 text-90">Trade License:</span><span><?php echo $d_info2['trade_license'] ?></span></div> -->
                    ...
                    <div class="text-95 col-sm-6 align-self-start d-sm-flex justify-content-end">
                        ...
                        <div class="text-grey-m2">
                            ...
                            <!-- 
                            <div class="my-2"><i class="fa fa-circle text-blue-m2 text-xs mr-1"></i> <span class="text-600 text-90">Created By:</span><span><?php echo $d['created_by'] ?></span></div> -->

                            <div class="my-2"><i class="fa fa-circle text-blue-m2 text-xs mr-1"></i> <span class="text-600 text-90">Created By:</span>
                                <span><?php echo $dl_nam['name'] ?></span>
                            </div>
                        </div>
                    </div>
                    <!-- /.col -->

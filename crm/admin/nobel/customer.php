...
$lead = $con->query('SELECT * from customers');
...
if (isset($_POST['name'])) {
  ...
  $query = "INSERT INTO customers(dealer_id,name,phone, email,address,organization)VALUES('$dealer_id','$name','$phone','$email','$address','$organization')";
  $con->query($query);
